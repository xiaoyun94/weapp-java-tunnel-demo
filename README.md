...
## 调试模式
在2017-05-08更新之后，增加了WS调试功能，请求的WS连接只需要一个参数对debug=debug便可以进行测试，但是每当新的连接产生时，旧的连接将会被关闭</br>
本项目的主页已经内嵌一个简易的WS程序，您可以通过此程序，快速进行调试。</br>
![image](https://github.com/xiaoyun94/weapp-java-tunnel-demo/blob/master/image/20170508172842.png)
